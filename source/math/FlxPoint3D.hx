 ...
 * 
 * ## Weak FlxPoint3Ds
 * Weak FlxPoint3Ds are FlxPoint3Ds meant for a singular use, rather than calling
 ...
 *
 * Note: that these operators get FlxPoint3Ds from the pool, but do not put
 * FlxPoint3Ds back in the pool, unless they are weak.
 * 
 * Example: 4 total FlxPoint3Ds are created, but only 3 are put into the pool
 * ```haxe
 ...
 * ```
 * 
 * Otherwise, the remainging FlxPoint3Ds will become garbage, adding to the
...
@:forward abstract FlxPoint3D(FlxBasePoint3D) to FlxBasePoint3D from FlxBasePoint3D {
	 ...
	 * @param   z  The Z-coordinate of the Point in space.
	 */
	...
	/**
	 * Operator that adds two FlxPoint3Ds, returning a new Point.
	 */
	@:noCompletion
	@:op(A + B)
	...
	/**
	 * Operator that subtracts two FlxPoint3Ds, returning a new Point.
	 */
	@:noCompletion
	@:op(A - B)
	 ...
	 * @return  The distance between the two FlxPoint3Ds as a Float.
	 */
	 ...
	 * @return  dot product of two FlxPoint3Ds
	 */
	...
	/**
	 * Dot product between two FlxPoint3Ds.
	 *
	 * @param   p  Point to multiply
	 * @return  dot product of two FlxPoint3Ds
	 */
	...
	/**
	 * Dot product of FlxPoint3Ds with normalization of the second Point.
	 *
	 * @param   p  Point to multiply
	 * @return  dot product of two FlxPoint3Ds
	 */
	...
	/**
	 * Check the perpendicularity of two FlxPoint3Ds.
	 *
	...
	/**
	 * Find the length of cross product between two FlxPoint3Ds.
	 *
	 * @param   p  Point to multiply
	 * @return  the length of cross product of two FlxPoint3Ds
	 */
	...
	/**
	 * Check for parallelism of two FlxPoint3Ds.
	 *
	 * @param   p  Point to check
	...
	/**
	 * Finding the Point of intersection of FlxPoint3Ds.
	 *
	 * @param   a  start Point of the Point
	 * @param   b  start Point of the p Point
	 * @param   p  the second Point
	 * @return the Point of intersection of FlxPoint3Ds
	 */
	...
	/**
	 * Finding the Point of intersection of FlxPoint3Ds if it is in the "bounds" of the FlxPoint3Ds.
	 *
	 * @param   a   start Point of the Point
	 * @param   b   start Point of the p Point
	 * @param   p   the second Point
	 * @return the Point of intersection of FlxPoint3Ds if it is in the "bounds" of the FlxPoint3Ds
	 */
	...
	/**
	 * Get the angle between FlxPoint3Ds (in radians).
	 *
	...
	/**
	 * The angle between FlxPoint3Ds (in degrees).
	 *
	 * @param   p   second Point, which we find the angle
	...
	/**
	 * The sign of half-plane of Point with respect to the Point through the a and b FlxPoint3Ds.
	 *
	...
	/**
	 * The distance between FlxPoint3Ds
	 * @since 6.0.0
	 */
	...
	/**
	 * The squared distance between FlxPoint3Ds
	 */
...
class FlxBasePoint3D implements IFlxPooled {
	 ...
	 * @return  True if the FlxBaseFlxPoint3Ds have the same x and y value, false otherwise.
	 */
 ...
 * IMPORTANT: Calling set(x, y); is MUCH FASTER than setting x and y separately. Needs to be destroyed unlike simple FlxFlxPoint3Ds!
 */
class FlxCallbackPoint3D extends FlxBasePoint3D {
	...
	override public function put():Void {} // don't pool FlxCallbackFlxPoint3Ds
}
